...
/* @vue/component */
  ...
  created: function created() {
    ...
    this.value.forEach(function (key) {
      return _this2.updateSelected(_this2.returnObject ? (0, _helpers.getObjectValueByPath)(key, _this2.itemKey) : key, true);
    });
    this.active.forEach(function (key) {
      return _this2.updateActive(_this2.returnObject ? (0, _helpers.getObjectValueByPath)(key, _this2.itemKey) : key, true);
    });
  },
...
>>>>>>> 4abe4c20526da80e85ad10371378d4beb2ef43f3
  ...
  render: function render(h) {
    var children = this.items.length ? this.items.map(_VTreeviewNode.default.options.methods.genChild.bind(this))
